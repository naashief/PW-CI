      ...
      <div class="card">
        ...
        <div class="col-md-12">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href= <?php echo base_url("index.php/mobil/delete/$mbl->id") ?> 
                                            ...
                                            onclick="return hapusMobil('Anda yakin ingin menghapus Mobil yang bernama <?php echo $mbl->warna ?>?')">Hapus <br>
                        ...
                        <?php
                            if($this->session->userdata('ROLE')=='administrator'){
                          ?>
                            <a href= <?php echo base_url("index.php/mobil/form") ?> class="btn btn-outline-primary" >Tambah
