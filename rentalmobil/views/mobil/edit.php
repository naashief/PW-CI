        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url("index.php/mobil") ?>">Data Mobil</a></li>
      ...
      <div class="card">
        ...
        <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                    <input id="warna" name="warna" placeholder="Masukkan Warna Kendaraan" type="text" value="<?php echo $obj_mobil->warna?>" class="form-control">
                    </div>
                </div>
                <div class="form-group row">
