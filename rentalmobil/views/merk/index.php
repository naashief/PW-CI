      ...
      <div class="card">
        ...
        <div class="col-md-12">
                        <table style="text-align: center;" border="1" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo base_url("index.php/merk/detail/$merk->id") ?>"
                          ...
                          ?>
                                        ...
                                        <a href= <?php echo base_url("index.php/merk/delete/$merk->id") ?> 
                                            ...
                                            onclick="return hapusMerk('Anda yakin ingin menghapus Merk yang bernama <?php echo $merk->nama ?>?')">Hapus <br>
                        ...
                        <?php
                            if($this->session->userdata('ROLE')=='administrator'){
                          ?>
                            <a href= <?php echo base_url("index.php/merk/form") ?> class="btn btn-outline-primary" >Tambah
