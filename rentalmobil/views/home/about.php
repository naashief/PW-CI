...
<head>
    <meta charset="utf-8">
    <title>Rental Mobil- About</title>
...
<body>
        ...
        <div class="row gx-0 d-none d-lg-flex">
            ...
            <div class="col-lg-5 px-5 text-end">
                ...
                <div class="h-100 d-inline-flex align-items-center">
                    <a class="btn btn-sm-square bg-white text-blue me-1" href="https://web.facebook.com/deri.rtg"><i class="fab fa-facebook-f"></i></a>
                    <a class="btn btn-sm-square bg-white text-blue me-0" href="https://www.instagram.com/deriyamsi/"><i class="fab fa-instagram"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="<?=base_url('index.php/home/about')?>" class="nav-item nav-link active">About</a>
    ...
    <!-- Page Header Start -->
    <div class="container-fluid page-header mb-5 p-0" style="background-image: url(<?=base_url('assets/img/mobil2.jpg')?>);">
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>rentalmobil.com</p>
