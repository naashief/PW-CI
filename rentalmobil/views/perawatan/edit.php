      ...
      <div class="card">
        ...
        <div class="form-group row">
                ...
                <div class="input-group">
                    ...
                    <input id="tanggal" name="tanggal" type="date" class="form-control" value="<?php echo $obj_perawatan->tanggal?>" required="required">
                </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="input-group">
                    ...
                    <input id="biaya" name="biaya" placeholder="Masukkan Biaya" type="text" value="<?php echo $obj_perawatan->biaya?>" class="form-control">
                </div>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                <textarea id="deskripsi" name="deskripsi" cols="40" rows="3" value="<?php echo $obj_perawatan->deskripsi?>" class="form-control"></textarea>
                </div>
            </div>
            <div class="form-group row">
