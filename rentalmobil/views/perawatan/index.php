                        ...
                        <table style="text-align: center;" border="1" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url("index.php/perawatan/detail/$prw->id") ?>"
                                        ...
                                        &nbsp;
                                        <a href= <?php echo base_url("index.php/perawatan/edit/$prw->id") ?> 
                                        ...
                                        &nbsp;
                                        <a href= <?php echo base_url("index.php/perawatan/delete/$prw->id") ?> 
                                            class="btn btn-outline-danger"
                                            onclick="return hapusPerawatan('Anda yakin ingin menghapus Perawatan Mobil yang bertanggal <?php echo $prw->tanggal ?>?')">Hapus <br>
                            ...
                            <a href= <?php echo base_url("index.php/perawatan/form") ?> class="btn btn-outline-primary" >Tambah
