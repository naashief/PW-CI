      ...
      <div class="card">
        ...
        <div class="form-group row">
                    ...
                    <div class="input-group">
                        ...
                        <input id="nama" name="nama" placeholder="Masukkan Jenis Perawatan Kendaraan" type="text" required="required" class="form-control">
                    </div>
                    </div>
                </div>
